...
<form class="cart" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button button btn1 bshadow alt"><span><?php echo esc_html( $product->single_add_to_cart_text() ); ?><i class="button-loader"></i></span></button>
